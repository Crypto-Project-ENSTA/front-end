  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="mt-4 text-muted-foreground text-sm md:text-base max-w-sm">
        This timeline illustrates the three main phases of the E-voting system, ensuring secure, anonymous, and verifiable electronic voting.
         </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-primary via-ring to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
